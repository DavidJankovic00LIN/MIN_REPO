...
const Landing = () => {
  return (
    <div className="hero min-h-screen relative bg-black/40">
    ...
    <div className='py-[25px]'>
      ...
      <div className="absolute top-24 left-12 bg-white/30 p-6 w-[300px] rounded-md backdrop-blur-md shadow-md">
      ...
      <div className="absolute top-12 right-12 bg-white/40 px-8 py-4 rounded-md backdrop-blur-md shadow">
        <span className="text-lg font-semibold text-gray-700">LOGO</span>
      </div>

      {/* Sekcija 2: Dole desno - Dobrodošli kartica */}
      <div className="absolute bottom-24 right-12 bg-white/40 p-6 w-[400px] rounded-md backdrop-blur-md text-gray-800 shadow-lg">
   ...
   <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex justify-center gap-4 bg-white/40 p-6 w-[350px] rounded-md backdrop-blur-md shadow-md">
